...
public class TrainModel
{
    ...
    public Double setSetpoint(double d)
    {
    	double v;
    	if (!eBrake)
    		v = engine.calculateSetpoint(d, (trainMass + passengers.getTotalPassengerMass()));
    	else
    		v = engine.pullEmergencyBrake(trainMass + passengers.getTotalPassengerMass());
...
>>>>>>> 839f508baec77617fb5c071fbf9b3583503758d0
=======
package trainmodule;
